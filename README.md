...
The file with the model and outcomes is "predictor.ipynb." The file with data preparation is "prepare_data_public.ipynb." Please note that to run the data notebook, you will need to provide your own API key. 
